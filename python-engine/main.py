...
class AttentionTracker:
    ...
    def analyze(self, prompt: str, response: str):
        ...
        prompt_end_idx = len(prompt_part_tokens['input_ids']) + 1 # +1 for the [CLS] token at the beginning
        ...
        response_attention_sum = torch.sum(cls_attentions[prompt_end_idx:total_tokens-1]).item() # -1 for [SEP]
...
async def lifespan(app: FastAPI):
    ...
    global llm_gguf_instance, compliance_model, compliance_tokenizer, attention_tracker
